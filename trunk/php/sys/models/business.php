...
{
  public function getBusiness($conditions = null, $page = 1, $limit = 10)
  {
    $mysqlModel = $this->getModel('mysql');
    $set = $mysqlModel->query('select d.*,count(*) from http_domain d inner join http_rule r on d.do_id = r.do_id group by d.do_id limit ' . $limit * ($page - 1) . ',' . $limit)->all();
  ...
  public function getHttpRule($set, $conditions = null, $page = 1, $limit = 10)
  {
    $result = array();
    $set1 = array();
    $mysqlModel = $this->getModel('mysql');
  ...
  public function getHttpData($set, $conditions = null, $page = 1, $limit = 10)
  {
    $mysqlModel = $this->getModel('mysql');
